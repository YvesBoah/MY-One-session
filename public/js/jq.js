/ *!
 * Bibliothèque JavaScript jQuery v3.0.0
 * https://jquery.com/
 *
 * Comprend Sizzle.js
 * https://sizzlejs.com/
...
(fonction (globale, usine) {
	...
	if (typeof module === "objet" && typeof module.exports === "objet") {
		...
		// Pour les environnements CommonJS et similaires, où une `fenêtre` appropriée
		// est présent, lance la fabrique et récupère jQuery.
		// Pour les environnements qui n'ont pas de `window` avec un` document`
		// (tel que Node.js), expose une fabrique sous la forme module.exports.
...
var
	...
	jQuery = fonction (sélecteur, contexte) {
		...
		// Need init si jQuery est appelé (permet que l'erreur soit renvoyée si elle n'est pas incluse)
	...
	rtrim = / ^ [\ s \ uFef \ xA0] + | [\ s \ uFef \ xA0] + $ / g,

	// Correspond à la chaîne en pointillés pour caméliser
	rmsPrefix = / ^ - ms- /,
	rdashAlpha = / - ([az]) / g,

	// Utilisé par jQuery.camelCase comme rappel à replace ()
...
jQuery.extend ({
	...
	isFunction: fonction (obj) {
		retourne jQuery.type (obj) === "fonction";
	},
	...
	isNumeric: function (obj) {
		...
		// À partir de jQuery 3.0, isNumeric est limité à
		// chaînes et nombres (primitives ou objets)
		// qui peut être contraint aux nombres finis (gh-2662)
		var type = jQuery.type (obj);
		return (type === "numéro" || type === "chaîne") &&

			// parseFloat NaNs convertit numériquement les faux positifs ("")
			// ... mais interprète mal les chaînes des nombres premiers, en particulier les littéraux hexadécimaux ("0x ...")
	...
	map: fonction (elems, callback, arg) {
		...
		// passe en revue chaque clé de l'objet,
		} autre {
			pour (i in elems) {
				valeur = rappel (elems [i], i, arg);
